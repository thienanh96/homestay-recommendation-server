...
````
python NeuMF.py --dataset ml-1m --epochs 20 --batch_size 256 --num_factors 16 --layers [64,32,16,8] --num_neg 4 --lr 0.001 --learner adam --verbose 1 --out 1 --mf_pretrain Pretrain/GMF.h5 --mlp_pretrain Pretrain/MLP.h5
`````
